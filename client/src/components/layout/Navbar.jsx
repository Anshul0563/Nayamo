  ...
  <AnimatePresence>
    {searchOpen && (
      <motion.div
        ...
        className="absolute right-14 top-1/2 -translate-y-1/2 origin-right z-50"
        style={{ width: "240px" }} // 🔥 FIXED WIDTH (no overflow)
      >
        <form onSubmit={submitSearch} className="w-full">
          <input
            ...
            placeholder="Search..."
            className="w-full h-12 rounded-2xl border border-white/10 bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-2xl px-4 text-sm text-white outline-none focus:border-[#D4A853]/60 shadow-xl"
          />
        </form>
      </motion.div>
    )}
