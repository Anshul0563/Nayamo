...
export default function Home() {
  ...
  return (
    <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <motion.div key={i} {...fadeInUp} transition={{ duration: 0.5, delay: i * 0.1 }} className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-sm hover:bg-white/10 transition-colors">
                ...
                <p className="text-[#D8CCC5] text-sm leading-relaxed mb-6">&ldquo;{t.text}&rdquo;</p>
      ...
      <section className="py-20 bg-[#FFFAF7]">
        <div className="nayamo-container">
          <motion.div {...fadeInUp} className="bg-white rounded-3xl p-10 md:p-14 text-center shadow-lg border border-[#F0E6E0] relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-lg mx-auto">
              ...
              <h2 className="text-2xl md:text-3xl font-serif font-semibold text-[#2C2C2C] mb-3">Join the Nayamo Club</h2>
              <p className="text-[#8C7B73] mb-8 max-w-md mx-auto">Subscribe for exclusive collections, styling tips, and special offers.</p>
